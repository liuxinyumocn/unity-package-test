...
namespace Unity.AutoStreaming.CloudContentDelivery
{
    ...
    internal class Util
    {
        ...
        public static string AppendHash128ToFileNameIfNeeded(string fullPath)
        {
            if (fullPath.StartsWith(Path.GetFullPath(ASBuildConstants.k_SceneABPath)) ||
                ...
                return Path.GetFileNameWithoutExtension(fullPath) + "_" + GetFileHash128(fullPath).ToString() + Path.GetExtension(fullPath);


            return Path.GetFileName(fullPath);
        }

        private static Hash128 GetFileHash128(string fullPath) 
        {

...
namespace Unity.AutoStreaming
{
    internal class ASTextureUI : TabBase<ASTexturesTreeView, ASTextureTreeDataItem>
    {
        ...
        Texture2D LoadTexture2DFromPath(string path)
        {
        ...
        void WriteOutAtlasTag2AbNameFile()
        {
        ...
        void GenerateTextureAssetBundles()
        {
            ...
            foreach (var item in allTexs)
            {
                ...
                {
                    UnityEngine.Debug.LogError("AutoStreaming: Missing Texture2D/Spriteatlas at path: " + item.assetPath);
                    continue;
                }
            ...
            if (abs.Count > 0)
            {
                ...
                BuildAssetBundleOptions buildABOption =
                    m_TexForceRebuildAssetBundle ? BuildAssetBundleOptions.ForceRebuildAssetBundle : BuildAssetBundleOptions.None;

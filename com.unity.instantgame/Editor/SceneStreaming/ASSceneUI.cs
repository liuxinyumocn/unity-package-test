...
namespace Unity.AutoStreaming
{
    internal class ASSceneUI : TabBase<ASScenesTreeView, ASSceneTreeDataItem>
    {
        ...
        void GenerateSceneAssetBundles()
        {
            ...
            var buildABOption = m_SceneForceRebuildAssetBundle ? BuildAssetBundleOptions.ForceRebuildAssetBundle : BuildAssetBundleOptions.None;

            if (m_SceneForceRebuildAssetBundle)
            {
